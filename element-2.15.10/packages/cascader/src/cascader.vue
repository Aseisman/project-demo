...
<script>
import Popper from '@moa/element-ui/src/utils/vue-popper';
import Clickoutside from '@moa/element-ui/src/utils/clickoutside';
import Emitter from '@moa/element-ui/src/mixins/emitter';
import Locale from '@moa/element-ui/src/mixins/locale';
import Migrating from '@moa/element-ui/src/mixins/migrating';
import ElInput from '@moa/element-ui/packages/input';
import ElTag from '@moa/element-ui/packages/tag';
import ElScrollbar from '@moa/element-ui/packages/scrollbar';
import ElCascaderPanel from '@moa/element-ui/packages/cascader-panel';
import AriaUtils from '@moa/element-ui/src/utils/aria-utils';
import { t } from '@moa/element-ui/src/locale';
import { isEqual, isEmpty, kebabCase } from '@moa/element-ui/src/utils/util';
import { isUndefined, isFunction } from '@moa/element-ui/src/utils/types';
import { isDef } from '@moa/element-ui/src/utils/shared';
import { addResizeListener, removeResizeListener } from '@moa/element-ui/src/utils/resize-event';
