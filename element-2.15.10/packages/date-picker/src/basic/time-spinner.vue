...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from '@moa/element-ui/src/utils/date-util';
  import ElScrollbar from '@moa/element-ui/packages/scrollbar';
  import RepeatClick from '@moa/element-ui/src/directives/repeat-click';
